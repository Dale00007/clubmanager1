...
<h2>List of players</h2>
    ...
    <TABLE align="left" class="sortable">
     ...
     <TR>
	   ...
	   <TH>Status<SPAN class="tooltip">Player status (closed / active)</SPAN></TH>		   	   
     </TR>
     </THEAD>
<?php
$team_id=$_SESSION['team_id'];
$sql = "SELECT * 
		FROM players,players_teams,players_status 
		WHERE players.id=players_teams.players_id
			AND players_teams.players_status_id=players_status.id
...
while ($row = $result->fetch_assoc()) {
 ...
 echo "<TR>
  ...
  <TD align='left'>$pcomment</TD>
  <TD align='left'>$player_status</TD>
  </TR>";
}
?>
